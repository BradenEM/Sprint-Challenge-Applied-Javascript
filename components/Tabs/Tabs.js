class TabLink {
  constructor(tabElement) {
    ...
    // Map over the newly converted NodeList we just created in our if statement above. Convert each
    // this.cards element into a new instance of the TabCard class. Pass in a card object to the TabCard class.
